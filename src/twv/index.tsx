...
// const [buttonClassName, { variants, sizes, severities }] = twv({ ???
const buttonClassName = twv({
  ...
  disabled: "cursor-not-allowed opacity-50 pointer-events-none disable",
...
function Button(props: ButtonProps) {
  const cm = buttonClassName(props);
  return (
